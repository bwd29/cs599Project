...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    // DTYPE index;
    // #pragma omp parallel for shared(index) num_threads(numActuators)
    for(DTYPE index = minAngle; index <= maxAngle; index+=actuatorStepSize){
        for(DTYPE j = minAngle; j <= maxAngle; j+=actuatorStepSize){
            World tempWorld = World(test);
            tempWorld.moveActuators(0,index);
